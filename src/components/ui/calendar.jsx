  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-slate-500 rounded-md w-9 font-medium text-[0.75rem]",
        ...
        day_selected:
          "bg-blue-600 text-white hover:bg-blue-700 hover:text-white focus:bg-blue-700 focus:text-white rounded-lg shadow-sm",
