    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500">{timeEntries.length} time entries logged</p>
            </div>
          </div>
        </div>
        ...
        <motion.div
          ...
          className={cn(
            "bg-white rounded-2xl border p-6 mb-6 shadow-sm",
            isOverBudget ? "border-red-200 bg-red-50/30" : "border-slate-100"
          )}
        >
          ...
          {budgetHours > 0 ? (
            <>
              <div className="flex items-end justify-between mb-3">
                <div>
                  <span className="text-4xl font-bold text-slate-900">{totalHours.toFixed(1)}</span>
                  <span className="text-lg text-slate-500 ml-1">/ {budgetHours}h</span>
                </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900">{thisWeekHours.toFixed(1)}h</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900">{Object.keys(hoursByMember).length}</p>
              </div>
            </div>
          </motion.div>
        </div>
                    ...
                    <div key={email} className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-sm text-slate-600">{data.hours.toFixed(1)}h</span>
                        </div>
