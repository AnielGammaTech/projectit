...
export default function ReportBuilder() {
  ...
  const calculateMetrics = () => {
    ...
    return {
      ...
      total_hours: Math.round(filteredTime.reduce((sum, t) => sum + (t.duration_minutes || 0), 0) / 60),
      billable_hours: Math.round(filteredTime.filter(t => t.billing_status !== 'excluded').reduce((sum, t) => sum + (t.duration_minutes || 0), 0) / 60),
